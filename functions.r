...
# This function generates time prediction for subchallenge 1b, using linear regression.
...
# This function generates the predicted risks and survival time in days.
